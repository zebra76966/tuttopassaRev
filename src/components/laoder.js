...
const Loader = () => {
  ...
  return (
    <div className="loader-container p-md-5 p-2">
      <img src="/assets/icons/badge (1).svg" className=" position-absolute top-0 start-0  scaleAnim d1 badgeS" style={{ height: "150px" }} />
      <img src="/assets/icons/badge (2).svg" className=" position-absolute top-0 end-0  scaleAnim d2 badgeS" style={{ height: "150px" }} />
      <img src="/assets/icons/badge (3).svg" className=" position-absolute bottom-0 start-0  scaleAnim d3 badgeS" style={{ height: "150px" }} />
      <img src="logo_tutto.svg" className=" position-absolute bottom-0 end-0  scaleAnim d4 badgeS" style={{ height: "150px", filter: "invert(1)" }} />
      ...
      <div className="w-100">
        ...
        <h5 className="text-start fs-4  loadtxt p-font txt-warning mt-4">
